# Version constraints for this module, matching networking/ and compute/.
#
# Registry module versions are NOT captured by .terraform.lock.hcl — that file
# only locks providers. The `version` argument on the ecr module block in main.tf
...
terraform {
  ...
  # reference another variable, and it is the version this repo is written for.
